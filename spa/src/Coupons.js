        ...
        <section id="coupon" className="section bg-light">
            <div className="container">
                <div className="gift-cards p-5">
                    <div style={{ flex: "1" }}>
                        <img style={{ width: "70%", borderRadius: "20%" }} src="https://beinggeeky-hnip75cdkgvvk6vt.web.codequotient.com/public/coupon.jpg" alt="" />
                    </div>
                    <div style={{ flex: "1" }}>
                        <h2 className="p-2">Coupons</h2>
                        ...
                        <hr /> <a href="/" className="text-secondary"><i className="fas fa-chevron-right"></i> Redeem </a>
                    </div>
                </div>
            </div>
        </section>
