    ...
    return (
        <>
            <section id="video" className="section bg-light"><div className="container">
                <h3 className=" p-lg-5">The video lecture you shouldn't miss</h3>
            ...
            <section style={{ backgroundColor: "rgb(71, 111, 112)", display: "flex", textAlign: "center", justifyContent: "center" }} id="entertainment" className="section p-lg-5">
                <div className="container  text-white p-lg-5">
                    <h2 className="section-head pt-5 ">Lectures available anywhere anytime</h2>
                    <p className="lead p-3" style={{ fontSize: "1.3rem" }}> You can watch the lecture anytime from anywhere and ask doubts.The phrasal sequence of the Lorem Ipsum text is now so widespread and commonplace that many DTP programmes can generate dummy text using the starting sequence "Lorem ipsum". Fortunately, the phrase 'Lorem Ipsum' is now recognized by electronic pre-press systems and, when found, an alarm can be raised. This avoids a publication going to print with overlooked dummy text.</p>
                </div>
            </section>
        </>
    )
